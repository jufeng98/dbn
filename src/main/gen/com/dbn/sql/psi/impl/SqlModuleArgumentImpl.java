...
public class SqlModuleArgumentImpl extends SqlPsiElement implements SqlModuleArgument {

  public SqlModuleArgumentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SqlVisitor visitor) {
    visitor.visitModuleArgument(this);
  }
