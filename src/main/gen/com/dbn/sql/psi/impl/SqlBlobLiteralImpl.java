...
public class SqlBlobLiteralImpl extends SqlPsiElement implements SqlBlobLiteral {

  public SqlBlobLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public PsiElement getDigit() {
    return findNotNullChildByType(DIGIT);
  }
