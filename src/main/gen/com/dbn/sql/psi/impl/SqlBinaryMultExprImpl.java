...
public class SqlBinaryMultExprImpl extends SqlExprImpl implements SqlBinaryMultExpr {

  public SqlBinaryMultExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull SqlVisitor visitor) {
    visitor.visitBinaryMultExpr(this);
  }
