...
public class SqlSavepointStmtImpl extends SqlPsiElement implements SqlSavepointStmt {

  public SqlSavepointStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SqlVisitor visitor) {
    visitor.visitSavepointStmt(this);
  }
  ...
  public PsiElement getSavepoint() {
    return findNotNullChildByType(SAVEPOINT);
  }
