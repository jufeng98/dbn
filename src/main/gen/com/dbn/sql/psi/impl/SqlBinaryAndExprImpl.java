...
public class SqlBinaryAndExprImpl extends SqlExprImpl implements SqlBinaryAndExpr {

  public SqlBinaryAndExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull SqlVisitor visitor) {
    visitor.visitBinaryAndExpr(this);
  }
