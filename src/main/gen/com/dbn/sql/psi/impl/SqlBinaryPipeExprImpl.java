...
public class SqlBinaryPipeExprImpl extends SqlExprImpl implements SqlBinaryPipeExpr {

  public SqlBinaryPipeExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull SqlVisitor visitor) {
    visitor.visitBinaryPipeExpr(this);
  }
