...
public class SqlUpdateStmtSubsequentSetterImpl extends SqlPsiElement implements SqlUpdateStmtSubsequentSetter {

  public SqlUpdateStmtSubsequentSetterImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SqlVisitor visitor) {
    visitor.visitUpdateStmtSubsequentSetter(this);
  }
